<x-call-to-action>
  <x-slot:title>
    ...
    <x-button-link href="https://github.com/salehalbalkhi" variant="dark" class="mr-3" target="_blank">
      View my github
    </x-button-link>
    <x-button-link href="https://www.youtube.com/UCixy_nJK3X00vvCVCDfMRdg" variant="red" target="_blank">
      Watch on YouTube
    </x-button-link>
</x-call-to-action>
